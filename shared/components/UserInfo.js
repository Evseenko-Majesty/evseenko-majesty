...
// Только аватар, имя, никнейм. Без позиционирования и размеров.
// Размеры задаются через CSS-классы в зависимости от места использования.
// ============================================
